export default function Footer() {
  return (
    <footer className="border-t border-gray-200 bg-white py-12 dark:border-[#232f48] dark:bg-surface-dark">
      <div className="mx-auto flex max-w-240 flex-col items-center justify-center px-4">
        ...
        <a className="group flex flex-col items-center gap-2 text-center" href="#">
          <h2 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white sm:text-4xl md:text-5xl group-hover:text-primary transition-colors">
