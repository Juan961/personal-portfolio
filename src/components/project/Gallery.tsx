export default function Gallery() {
  return (
    <div className="mb-16">
      <h3 className="mb-6 text-xl font-bold uppercase tracking-tight text-slate-900 dark:text-white">Interface Gallery</h3>
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="group relative aspect-4/3 cursor-pointer overflow-hidden rounded-lg bg-slate-100 dark:bg-surface-dark">
